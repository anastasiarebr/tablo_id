...
<div class="titles">
  ...
  <div class="talonColumn">
    <TalonColumn :arrow = 'arrow.slice(0, 5)' :widthT = '50' :fszTalon = '120' :fszTable = '120'/>
    <TalonColumn :arrow = 'arrow.slice(5, arrow.length)' :widthT = '50' :fszTalon = '120' :fszTable = '120' />
  </div>
</template>

<script>
import TalonColumn from './TalonColumn.vue'
export default {
  components: {
    TalonColumn
  },
